...
export default function ScreenShot() {
  ...
  const [toolPos, setToolPos] = useState<{ x: number; y: number }>({ x: 0, y: 0 })
  ...
  const saveSelectedAreaToImage = () => {
  if (!canvasRef.current || !startPos || !currentPos) return
  ...
  >
    ...
    <img
      ...
      alt="选区预览"
      style={{ maxWidth: '200px', maxHeight: '150px', border: '1px solid gray' }}
    />
  </div>
)}
