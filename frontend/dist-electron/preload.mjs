...
(function(exports) {
  ...
  __exportStar(remote$1, exports);
})(renderer$1);
var renderer = renderer$1;
const remote = /* @__PURE__ */ getDefaultExportFromCjs(renderer);
console.log("✅ preload.js 注入成功");
require$$0.contextBridge.exposeInMainWorld("ipcRenderer", {
  on(...args) {
    const [channel, listener] = args;
    return require$$0.ipcRenderer.on(
      channel,
  ...
  openPlugin: (pluginName) => require$$0.ipcRenderer.invoke("open-plugin", pluginName)
});
require$$0.contextBridge.exposeInMainWorld("market", {
  getLocalPlugins() {
